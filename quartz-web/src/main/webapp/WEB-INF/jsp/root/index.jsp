...
<head>
    ...
    <title>首页</title>
    <meta name="Keywords" content="B-JUI,Bootstrap,jquery,ui"/>
    <meta name="Description" content="B-JUI(Best jQuery UI)前端管理框架"/>
    <!-- bootstrap - css -->
    <link href="/common/B-JUI/themes/css/bootstrap.css" rel="stylesheet">
    <!-- core - css -->
    <link href="/common/B-JUI/themes/css/style.css" rel="stylesheet">
    <link href="/common/B-JUI/themes/blue/core.css" class="bjui-link-theme" rel="stylesheet">
    <link href="/common/B-JUI/themes/css/fontsize.css" class="bjui-link-theme" rel="stylesheet">
    <!-- plug - css -->
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon-precomposed" href="/common/assets/ico/apple-touch-icon-precomposed.png.png">
    ...
    <link href="/common/assets/prettify.css" rel="stylesheet">
    <script src="/common/assets/prettify.js"></script>
    <link href="/common/assets/ZeroClipboard.css" rel="stylesheet">
    <script src="/common/assets/ZeroClipboard.js"></script>
</head>
<body>
<!--[if lte IE 7]>
<div id="errorie">
    ...
    <div class="container_fluid">
        ...
        <nav class="collapse navbar-collapse" id="bjui-top-collapse">
            <ul class="nav navbar-nav navbar-right">
                <li class="datetime"><a><span id="bjui-date">0000-00-00</span> <span id="bjui-clock">00:00:00</span></a>
                </li>
                ...
                <li>
                    <c:if test="${user.auth eq 1}">
                        <a href="/admin/page/updatePassWordPage" data-toggle="dialog" data-id="sys_user_changepass"
                           data-mask="true" data-width="400" data-height="300">修改密码</a>
                    </c:if>
                    <c:if test="${user.auth eq 0}">
                        <a href="/user/page/updatePassWordPage" data-toggle="dialog" data-id="sys_user_changepass"
                           data-mask="true" data-width="400" data-height="300">修改密码</a>
                    </c:if>
                </li>
                ...
                <li class="dropdown active"><a href="#" class="dropdown-toggle theme" data-toggle="dropdown"
    ...
    <div class="container_fluid">
        ...
        <nav class="collapse navbar-collapse" id="bjui-navbar-collapse">
            <ul class="nav navbar-nav navbar-right" id="bjui-hnav-navbar">
                <c:if test="${user.auth eq 1}">
                    <li class="active">
                        <a href="/common/json/menu-form.json" data-toggle="sidenav" data-id-key="targetid">用户管理</a>
                    </li>
                </c:if>
                <li>
                    <a href="/common/json/menu-base.json" data-toggle="sidenav" data-id-key="targetid">操作记录</a>
                </li>
                <li>
                    <a href="/common/json/menu-datagrid.json" data-toggle="sidenav" data-id-key="targetid">数据管理</a>
                </li>
            </ul>
        </nav>
    </div>
    ...
    <div class="container_fluid" id="bjui-body">
        <div id="bjui-sidenav-col">
            <div id="bjui-sidenav">
                <div id="bjui-sidenav-arrow" data-toggle="tooltip" data-placement="left" data-title="隐藏左侧菜单">
                    <i style="margin-top: 25%;" class="fa fa-long-arrow-left"></i>
                </div>
        ...
        <div id="bjui-navtab" class="tabsPage">
            <div id="bjui-sidenav-btn" data-toggle="tooltip" data-title="显示左侧菜单" data-placement="right">
                <i style="margin-top: 25%;" class="fa fa-bars"></i>
            </div>
