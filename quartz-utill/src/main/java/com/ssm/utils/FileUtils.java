...
public class FileUtils extends org.apache.commons.io.FileUtils {
    ...
    public static boolean copyFileCover(String srcFileName,
                                        String descFileName, boolean coverlay) throws Exception {
    ...
    public static boolean copyDirectoryCover(String srcDirName,
                                             String descDirName, boolean coverlay) throws Exception {
    ...
    public static boolean createFile(String descFileName) throws Exception {
        ...
        if (descFileName.endsWith(File.separator)) {
            logger.info(descFileName + " 为目录，不能创建目录!");
            return false;
        }
        if (!file.getParentFile().exists()) {
            // 如果文件所在的目录不存在，则创建目录
            if (!file.getParentFile().mkdirs()) {
                logger.info("创建文件所在的目录失败!");
                return false;
            }
        }
        ...
        try {
            ...
            logger.info(descFileName + " 文件创建失败!" + e.getMessage());
            return false;
        }
